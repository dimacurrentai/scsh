...
command -v packdiff >/dev/null 2>&1 \
  ...
  || echo "packdiff: not found (optional) — install with \`cargo install packdiff --version 0.6.2 --locked\` to see per-step commit diffs"
