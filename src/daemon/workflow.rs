...
pub enum WorkflowDisplayState {
  ...
  Graceful,
  Failed,
  /// Failed with a login rejection in the recording: an uncertain diagnostic only.
  LikelyExpiredCredentials,
...
impl WorkflowDisplayState {
  pub fn as_str(self) -> &'static str {
    match self {
      ...
      Self::Failed => "failed",
      Self::LikelyExpiredCredentials => "login",
  ...
  pub fn label(self) -> &'static str {
    match self {
      ...
      Self::Failed => "Failed",
      Self::LikelyExpiredCredentials => "Likely expired credentials",
      Self::ForceStopped => "Stopped",
      Self::Skipped => "Skipped",
  ...
  match node_proc(session, node) {
    ...
    Some(p) => match p.status {
      ...
      ProcStatus::Fail => {
        ...
        } else if p.suspected_cause == Some(crate::failure::SuspectedCause::ExpiredCredentials) {
